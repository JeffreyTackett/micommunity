...
DEFAULT_WELCOME = "Hi! {first}, welcome to MIUI Beta Team, do read the rules and important instructions and follow them"
DEFAULT_GOODBYE = "Thanks for your contribution, See Ya around!"
